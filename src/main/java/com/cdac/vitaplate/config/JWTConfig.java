package com.cdac.vitaplate.config;
...
public class JWTConfig {
    ...
    private static final Logger logger = (Logger) LoggerFactory.getLogger(JWTConfig.class);
    ...
    public String generateToken(String email, String role) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60)) // Set the expiration (1 hour in
                                                                                      // this case)
